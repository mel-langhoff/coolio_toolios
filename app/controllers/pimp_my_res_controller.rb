...
render pdf: "Melissa_Langhoff_resume",
  ...
  def build_messages(professional_data, scraped_job, body_text)
    ...
    [
      ...
      { role: "user", content: "Don't include my projects unless it's for a software developer job because they are irrelevant unless it's for a technical project management job. Use your smarts and judgment if the project is relevant for the job or not. If only one project is relevant, do not put it, if two or more projects are relevant, put them but do not put more than three. Put only one or two short sentences about each project. Do not have the projects take up more than a quarter to one third of the resume. Give a description of the project and what it does, do not just say that it showcases my skills say HOW it showcases my skills. Do not write about the projects in first person. If there is not enough data to say how it showcases my skills, leave it off." },
      { role: "user", content: "Jk about the 100% factual; use the information scraped from the job posting to even just flub some information that looks realistic in the resume, such as making up a percentage or making up a believable thing that I wouldn't need to prove in an interviw. Anything to give me a leg up. Nothing I would have to be specific about in an interview or something I could easily make up a story about. Make it belieavle and realistic." },   
